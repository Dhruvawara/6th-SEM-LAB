...
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("1JS18CS403 - Dhruva V : COHEN-SUTHERLAND ALGORITHM");
...
// dhruvawara@dbuntu:~/6th-SEM-LAB/CG/5th Program$ cc Program5.c -lglut -lGL -lGLU -lm -o Program5.out
// dhruvawara@dbuntu:~/6th-SEM-LAB/CG/5th Program$ ./Program5.out
// enter pts
// 0 50 100 100
// dhruvawara@dbuntu:~/6th-SEM-LAB/CG/5th Program$ ./Program5.out
// enter pts
