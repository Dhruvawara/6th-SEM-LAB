...
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("1JS18CS403 - Dhruva V : CUBE PRESPECTIVE");
...
// dhruvawara@dbuntu:~/6th-SEM-LAB/CG/4th Program$ cc Program4.c -lglut -lGL -lGLU -lm -o Program4.out
// dhruvawara@dbuntu:~/6th-SEM-LAB/CG/4th Program$ ./Program4.out