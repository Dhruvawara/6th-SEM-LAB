// Write a program to develop a menu driven program to animate a flag using Bezier Curve algorithm
...
void bezier(struct wcPt3D *ctrlPts, GLint nCtrlPts, GLint nBezCurvePts)
{
    ...
    GLfloat u;
    GLint *C, k;
    C = malloc(nCtrlPts * sizeof(GLint));
    bino(nCtrlPts - 1, C);
...
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("1JS18CS403 - Dhruva V : BEZIER CURVE ALGORITHM");
    CreateMenu();
...
// dhruvawara@dbuntu:~/6th-SEM-LAB/CG/8th Program$ cc Program8.c -lglut -lGL -lGLU -lm -o Program8.out
// dhruvawara@dbuntu:~/6th-SEM-LAB/CG/8th Program$ ./Program8.out