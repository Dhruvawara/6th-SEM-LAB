...
int main(int argc, char **argv)
{
    ...
    sb = glutCreateWindow("1JS18CS403 - Dhruva V : Rotate A Triangle FIXED POINT");
    minit();
    glutDisplayFunc(ds);
    ...
    db = glutCreateWindow("1JS18CS403 - Dhruva V : Rotate A Triangle ORIGIN");
    minit();
    glutDisplayFunc(dd);
    glutReshapeFunc(myres);
    glutIdleFunc(sd);
...
// dhruvawara@dbuntu:~/6th-SEM-LAB/CG/2nd Program$ cc Program2.c -lglut -lGL -lGLU -lm -o Program2.out
// dhruvawara@dbuntu:~/6th-SEM-LAB/CG/2nd Program$ ./Program2.out