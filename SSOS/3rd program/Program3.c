...
// ParsingTable for the grammar rules: A →aBa , B →bB | ε. Use this table to 
...
// dhruvawara@dbuntu:~/6th-SEM-LAB/SSOS/3rd program$ cc Program3.c -ll -o Program3.out
// dhruvawara@dbuntu:~/6th-SEM-LAB/SSOS/3rd program$ ./Program3.out
